...
<div class="filmstrip" id="fsInline3">
	<div class="filmstripWindow">
		<ul class="listTypeFilmstrip">
			<li>
				...
				<div class="filmstripThumbnailText">
					...
					<a href="http://google.com" class="readmore">View Now &gt;</a>
				</div>
			</li>
			<li>
			...
			<li>
				<div class="filmstripThumbnailHeader">SpiceWorks Gen8 Webinar</div><div class="filmstripThumbnail"><img data-src="example.com/200x60/mo"></div>
				<div class="filmstripThumbnailText">
